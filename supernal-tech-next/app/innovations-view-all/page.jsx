  ...
  return (
    <>
      ...
      <link rel="icon" type="image/svg+xml" href="/Ife_Logo.png" />
       ...
       <section className="flex flex-wrap bg-black justify-around items-center bg-[url('/images/table-bg.svg')] bg-cover bg-center bg-no-repeat w-full h-[80vh]">
        <motion.div
        ...
        >
          <div className=" flex flex-col space-y-4 w-[60vw] h-[40vh] bg-[#C28D01]  rounded-3xl m-10 flex-wrap space-x-20  justify-center items-center text-white">
            ...
            >
              <p className="text-[1rem] max-w-xl text-center">
