      ...
      <section className="bg-white min-h-screen  flex flex-wrap justify-center space-x-15 items-center">
        <div>
          ...
          <p className="text-[1rem] mt-5 max-w-xl font-light text-cente md:text-balance">
            Our IT consultancy services are crafted to empower your business
            with strategic technology solutions and expert guidance. We
            specialize in optimizing your IT infrastructure and aligning
            technology with your business goals. From strategic IT planning to
            cybersecurity assessment and digital transformation, we offer
            comprehensive solutions that drive efficiency, innovation, and
            growth. Partner with us to navigate complex IT challenges,
            streamline operations, and unlock the full potential of your
      ...
      <section className="min-h-screen">
        <div className=" flex flex-col flex-wrap mt-10 justify-cente items-start py-10 px-30 ">
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Tailored roadmaps and plans to align technology initiatives with
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Comprehensive evaluation of current infrastructure with
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Customized strategies and seamless deployment of cloud solutions
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Thorough risk assessment, strategy development, and implementation
