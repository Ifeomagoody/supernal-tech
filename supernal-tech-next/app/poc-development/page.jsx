      ...
      <section className="bg-white min-h-screen  flex flex-wrap justify-center space-x-15 items-center">
        <div>
          ...
          <p className="text-[1rem] mt-5 max-w-xl font-light text-cente md:text-balance">
            At InnovateTech Solutions, our PoC (Proof of Concept) development
            service is dedicated to bringing your innovative ideas to life with
            precision and efficiency. We specialize in validating the
            feasibility of your technological concepts, providing a clear path
            forward for successful product development.
          </p>
          <p className="text-[1rem] mt-5 max-w-xl font-light text-cente md:text-balance">
            Our service begins with collaborative ideation sessions to refine
            and crystallize your ideas into a well-defined concept for the PoC.{" "}
          </p>
        </div>
      ...
      <section className="min-h-screen">
        <div className=" flex flex-col flex-wrap mt-10 justify-cente items-start py-10 px-30 ">
          ...
          <p className="text-white text-[1.2rem] mt-5 max-w-4x font-light leading-[2] md:text-balanc">
            Here are the components typically included in a PoC (Proof of
          ...
          <p className="text-white text-[1.2rem] mt-5 max-w-4x font-light leading-[2] md:text-balanc">
            Collaborative sessions to refine and crystallize innovative ideas
            into a defined PoC concept.
          </p>
          <h3 className="font-medium text-[2rem] text-white leading-[3]">
            Rapid Prototyping:
          </h3>
          <li className="text-white text-[1.2rem] leading-[3]">
            Swift creation of functional prototypes to demonstrate core features
            and validate technical feasibility.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Iterative development cycles allowing for continuous feedback and
            refinement of the PoC.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Assessment of suitable technologies and platforms to support the
            PoC&lsquo requirements and scalability.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Presentation and demonstration of the PoC to stakeholders,
            highlighting its potential value and market readiness.
          </li>
          <h3 className="font-medium text-[2rem] text-white leading-[3]">
            Performance Evaluation:
          </h3>
          <li className="text-white text-[1.2rem] leading-[3]">
            Rigorous testing and analysis to assess performance metrics,
            scalability, and reliability of the PoC.
          </li>
        </div>
      </section>
