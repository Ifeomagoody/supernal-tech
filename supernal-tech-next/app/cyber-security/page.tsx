      ...
      <section className="bg-white min-h-screen  flex flex-wrap justify-center space-x-15 items-center">
        <div>
          ...
          <p className="text-[1rem] mt-5 max-w-xl font-light text-cente md:text-balance">
            In today&lsquo interconnected world, cyber security is more critical
            than ever. At Tech Hub, we provide comprehensive cyber security
            solutions designed to protect your business from ever-evolving
            threats. Our team of experts leverages the latest technologies and
            industry best practices to secure your digital assets and ensure
            your business remains resilient against cyber attacks.
          </p>
        </div>
      ...
      <section className="min-h-screen">
        <div className=" flex flex-col flex-wrap mt-10 justify-cente items-start py-10 px-30 ">
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Continuous monitoring of your network to detect and respond to
            threats in real-time.
          </li>
          <li className="text-white text-[1.2rem] ">
            Advanced threat intelligence to identify and mitigate potential
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Regular scans and assessments to identify vulnerabilities in your
            systems and applications.
          </li>
          <li className="text-white text-[1.2rem] ">
            Strategic recommendations and remediation plans to address
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Robust protection for all endpoints, including desktops, laptops,
            and mobile devices.
          </li>
          <li className="text-white text-[1.2rem] ">
            Anti-virus, anti-malware, and anti-ransomware solutions to safeguard
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            ...
            intrusion prevention systems (IPS) to secure your network perimeter.
          </li>
          <li className="text-white text-[1.2rem] ">
            Secure VPNs and encryption protocols to protect data in transit.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Encryption of sensitive data to prevent unauthorized access and
            ensure data privacy.
          </li>
          <li className="text-white text-[1.2rem] ">
            Secure backup solutions to safeguard data against loss or
            corruption.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            ...
            authentication (MFA), to ensure only authorized users can access
            your systems.
          </li>
          <li className="text-white text-[1.2rem] ">
