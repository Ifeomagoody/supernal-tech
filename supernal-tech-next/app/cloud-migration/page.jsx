      ...
      <section className="bg-white min-h-screen  flex flex-wrap justify-center space-x-15 items-center">
        <div>
          ...
          <p className="text-[1rem] mt-5 max-w-xl font-light text-cente md:text-balance">
            Our cloud migration services empower businesses to navigate the
            complexities of transitioning their operations and data to cloud
            environments with ease. We excel in meticulously planning and
            executing each stage of the migration journey, from initial
            assessment and strategy development to seamless execution and
            post-migration support. By optimizing performance, enhancing
            scalability, and maximizing cost-efficiency, we enable organizations
            to harness the full potential of cloud computing while minimizing
            disruptions and maximizing return on investment.
          </p>
        </div>
      ...
      <section className="min-h-screen">
        <div className=" flex flex-col flex-wrap mt-10 justify-cente items-start py-10 px-30 ">
          ...
          <p className="text-white text-[1.2rem] mt-5 max-w-4x font-light leading-[2] md:text-balanc">
            Our comprehensive cloud migration service is designed to support
            businesses throughout every phase of their transition to cloud
            computing, ensuring a seamless and successful adoption:
          </p>
          <h3 className="font-medium text-[2rem] text-white leading-[3]">
            Assessment and Planning:
          </h3>
          <p className="text-white text-[1.2rem] mt-5 max-w-4x font-light leading-[2] md:text-balanc">
            Detailed evaluation of your current infrastructure and applications
            to develop a strategic migration roadmap aligned with your business
            objectives.
          </p>
          <h3 className="font-medium text-[2rem] text-white leading-[3]">
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Customized migration strategy outlining timelines, resource
            requirements, and milestones to achieve a smooth transition.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Expert execution of the migration process, including application and
            data transfer, to minimize downtime and ensure data integrity.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Seamless integration of cloud solutions with your existing IT
            environment, optimizing performance and scalability.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Implementation of robust security measures and compliance with
            industry regulations to protect your data and ensure regulatory
            adherence.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Provision of training sessions and ongoing support to empower your
            team with cloud management skills and ensure smooth post-migration
            operations.
          </li>
        </div>
      </section>
