      ...
      <section className="bg-white min-h-screen  flex flex-wrap justify-center space-x-15 items-center">
        <div>
          ...
          <p className="text-[1rem] mt-5 max-w-xl font-light text-cente md:text-balance">
            At Tech Hub, we specialize in crafting custom mobile applications
            that drive innovation and accelerate digital transformation for
            businesses of all sizes. Whether you're a startup or a large
            enterprise, our dedicated team of app developers and designers is
            here to turn your ideas into intuitive and impactful mobile
            solutions.
          </p>
        </div>
      ...
      <section className="min-h-screen">
        <div className=" flex flex-col flex-wrap mt-10 justify-cente items-start py-10 px-30 ">
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Tailored solutions for iOS and Android platforms, designed to meet
            your unique business requirements.
          </li>
          <li className="text-white text-[1.2rem] ">
            User-friendly interfaces and intuitive designs that enhance user
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            From ideation and concept validation to design, development,
            testing, and deployment.
          </li>
          <li className="text-white text-[1.2rem] ">
            Agile development methodologies to ensure flexibility and
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Development of apps that work seamlessly across multiple platforms,
            including iOS, Android, and web.
          </li>
          <li className="text-white text-[1.2rem] ">
            Code reusability and efficient maintenance to optimize development
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Creative and user-centric design strategies to create visually
            appealing and intuitive interfaces.
          </li>
          <li className="text-white text-[1.2rem] ">
            Prototyping and wireframing to validate design concepts and gather
            early feedback.
          </li>
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Robust backend solutions to support app functionality, data storage,
            and user management.
          </li>
          <li className="text-white text-[1.2rem] ">
            Integration with third-party APIs and services to enhance app
          ...
          <li className="text-white text-[1.2rem] leading-[3]">
            Comprehensive testing processes, including functional testing,
            performance testing, and security testing.
          </li>
          <li className="text-white text-[1.2rem] ">
            Continuous quality assurance to ensure app stability, reliability,
            and scalability.
          </li>
        </div>
      </section>
