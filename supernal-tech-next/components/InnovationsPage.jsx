...
export default function page() {
  return (
    <>
             ...
             <title>Insights & Innovations</title>
       ...
       <motion.div
        ...
        <div className="md:flex md:justify-around items-center pt-10">
            ...
            <div>
              ...
              <Link href="/innovations-view-all">
             <div className="bg-[#C28D01] flex justify-center hover:bg-transparent border border-[#C28D01] hover:text-[#C28D01] px-[2rem] py-[1rem] rounded-full text-[1.3rem]  items-center gap-2 text-white">
                      View all
                      <Image
