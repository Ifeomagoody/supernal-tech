       ...
       <section className="flex flex-wrap  justify-around items-center bg-[url('/images/table-bg.svg')] bg-cover bg-center bg-no-repeat w-full ">
                <div className="md:flex md:flex-col md:items-start items-center md:text-left text-center px-4">
                  ...
                  >
                    ...
                    <div className="bg-[#C28D01] my-10 flex justify-center hover:bg-transparent border border-[#C28D01] hover:text-[#C28D01] px-[1rem] py-[1rem] rounded-full text-[1.3rem]  items-center gap-2 text-white">
                      Discover Now
                      <Image
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="absolute top-1/3.5 right-15 animate-icon-5 z-30 px-4 py-3 rounded-2xl border border-[#ffffff26]  bg-[#ffffff26]">
                      <img
