        ...
        <div className="fixed  bg-black p-4 right-0 left-0 top-0  flex sm:gap-3 justify-between items-center">
          ...
          {navOpen ? (
            <div className="bg-black overflow-y-hidden fixed z-10 top-0 left-0 p-5 min-h-screen flex flex-col gap-1 duration-300 ease-in">
              ...
              <Link href="/app/navbar-get-in-touch">

              <div className="bg-[#C28D01] flex justify-center hover:bg-transparent border border-[#C28D01] hover:text-[#C28D01] px-[1rem py-[1rem] rounded-full text-[1.3rem]  items-center gap-2 text-white">
                Get in Touch
                <Image
          ...
          <Link href="/navbar-get-in-touch">
          
          <div className="bg-[#C28D01] md:flex hidden hover:bg-transparent border border-[#C28D01] hover:text-[#C28D01] px-[1.8rem] py-[1rem] rounded-full text-[1.3rem]  items-center gap-2 text-white">
            Get in Touch
            <Image
              src="/arrow-up-solid-full.svg"
              alt="navigation"
